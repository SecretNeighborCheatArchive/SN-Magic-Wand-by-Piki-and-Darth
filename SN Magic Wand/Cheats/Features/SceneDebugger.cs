...
{
    static class SceneDebugger
    {
        static Int32 HierarchyWindowId;
        static Int32 ProjectWindowId { get { return HierarchyWindowId + 1; } }
        static Int32 InspectorWindowId { get { return ProjectWindowId + 1; } }
        static Int32 Margin = 50;
        static Rect HierarchyWindow;
        static Int32 HierarchyWidth = 400;
        static Vector2 HierarchyScrollPos;
        static String SearchText = "";
        static Vector2 PropertiesScrollPos;
        static Transform SelectedGameObject;
        static List<String> ExpandedObjs = new List<String>();

        static Rect ProjectWindow;
        static Int32 ProjectWidth = 400;
        static Vector2 ProjectScrollPos;
        static ConcurrentDictionary<object, Boolean> ExpandedObjects = new ConcurrentDictionary<object, Boolean>();

        static Rect InspectorWindow;
        static Int32 InspectorWidth = 350;
        ...
        static void DisplayGameObject(GameObject gameObj, Int32 level)
        {
        ...
        static void HierarchyWindowMethod(Int32 id)
        {
        ...
        #region Project GUI
        static void ProjectWindowMethod(Int32 id)
        {
            GUILayout.BeginVertical(GUIContent.none, GUI.skin.box, new GUILayoutOption[0]);// GUI.skin.box);
            {
